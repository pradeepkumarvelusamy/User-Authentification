...
public class EntityTests {
	...
	public void getAndSetName() {
		...
		testUser.setName("pradeep");
		assertEquals(testUser.getName(),"pradeep");
	}
	...
	public void getAndSetEmail() {
		...
		testUser.setEmail("pradeep@email.com");
		assertEquals(testUser.getEmail(),"pradeep@email.com");
	}
	...
	public void checkConstructor() {
		User testUser = new User("pradeep","pradeep@email.com","123");
		
		User checkUser = new User();
		checkUser.setName("pradeep");
		checkUser.setEmail("pradeep@email.com");
